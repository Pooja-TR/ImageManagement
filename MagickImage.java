...
public class MagickImage extends Magick {
     ...
     * Set the fuzz.
     *
     * @param filter the fuzz factor
     * @exception MagickException on error
     */
    public native void setFuzz(double fuzz)
    throws MagickException;
    ...
    /**
     * Simulates motion blur. We convolve the image with a Gaussian operator of the given radius and 
     * standard deviation (sigma). For reasonable results, radius should be larger than sigma. Use a 
     * radius of 0 and MotionBlurImage() selects a suitable radius for you. Angle gives the angle of 
     * the blurring motion
     *
     * @param channel The channel(s) to which the blurring should apply
	 				 (see ChannelType)
     ...
     * @exception MagickException on error
     */
    public native MagickImage motionBlurImage(double radius, double sigma, double angle)
    throws MagickException;

    
    /**
     * ShadeImage() shines a distant light on an image to create a three-dimensional effect. 
     * You control the positioning of the light with azimuth and elevation; azimuth is measured 
     * in degrees off the x axis and elevation is measured in pixels above the Z axis.
     *
     ...
     * @exception MagickException on error
     */
    public native MagickImage shadeImage(boolean gray, double azimuth, double elevation)
    throws MagickException;
...
/**
     ...
     * @param metric the type metrics to be returned
     */
    public native int drawMagickCaption(DrawInfo info, int leading, String caption);
    ...
    /**
     * Carries out a distort operation on an image
     *
     * @param method - the distortion method
     * @param args - an array of arguments
     * @param bestFit - Attempt to 'bestfit' the size of the resulting image
     *
     * @return A new image with the distortion applied.
     * @exception MagickException on error
     */
    
    public native MagickImage distortImage(int method, double[] args, boolean bestFit)
    throws MagickException;
